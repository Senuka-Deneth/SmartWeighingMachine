...
select id, 1, 'Rice', 'active', 25, 25, 5, gen_random_uuid()::text
...
select id, 2, null, 'inactive', 25, 0, 5 from machines where machine_number = 1;

insert into compartments (machine_id, slot_number, product_name, status, total_capacity, current_stock, low_stock_threshold)
select id, 3, null, 'inactive', 25, 0, 5 from machines where machine_number = 1;

insert into compartments (machine_id, slot_number, product_name, status, total_capacity, current_stock, low_stock_threshold)
select id, 4, null, 'inactive', 25, 0, 5 from machines where machine_number = 1;
